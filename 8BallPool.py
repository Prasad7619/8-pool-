...
def border():
    pygame.draw.rect(display, yellow, (0, 0, width, 30))
    pygame.draw.rect(display, yellow, (0, 0, 30, height))
    pygame.draw.rect(display, yellow, (width - 30, 0, width, height))
    pygame.draw.rect(display, yellow, (0, height - 30, width, height))
